...
export const Alert = (props: { title: string; message: string; type: "danger"|"info", onClose: ()=>void}) => {
  ...
  return (
    ...
    >
      ...
      >
        <svg
          className={`fill-current h-6 w-6 ${type === "danger" ? "text-red-500" : "text-green-500"}`}
          role="button"
